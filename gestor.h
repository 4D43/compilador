...
extern char tabla_join[MAX_LEN]; // Nombre de la segunda tabla en el JOIN (tabla derecha)
// Para almacenar el esquema de la segunda tabla (tabla derecha)
...
// Para la condición de JOIN (ej. t1.col1 = t2.col2)
